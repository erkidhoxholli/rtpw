...
export function Form({onSubmit}: IProps ) {
    ...
    return (
        <form onSubmit={onSubmit}>
            <Input type="text" label={intl.formatMessage(messages.formNameLabel)} name="name" validators={validator.name}/>
            <Input type="email" label={intl.formatMessage(messages.formEmailLabel)} name="email" validators={validator.email} />
            <Input type="password" label={intl.formatMessage(messages.formPasswordLabel)} name="password" validators={validator.password}/>
